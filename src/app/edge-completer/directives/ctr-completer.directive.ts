...
export class CtrCompleterDirective {
  ...
  @Output()
  public selected = new EventEmitter<CompleterItem | null>();
  @Output()
  public highlighted = new EventEmitter<CompleterItem | null>();
  @Output()
  public opened = new EventEmitter<boolean>();
  @Output()
  public dataSourceChange = new EventEmitter<void>();
