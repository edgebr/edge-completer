...
@Component({
  ...
  templateUrl: './edge-completer-list-item.component.html',
  styleUrls: ['./edge-completer-list-item.component.css']
})
export class EdgeCompleterListItemComponent implements OnInit {
  @Input()
  public text: string;
  @Input()
